...
- Commonly used libraries should be used in preference to custom CSS or code.
...
- Client-side preview of brightness/contrast adjustments before submitting to the backend API. Use HTML5 `<canvas>` for these previews.
